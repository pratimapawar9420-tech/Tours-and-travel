  ...
  <body>
    ...
    <section id="overview">
      <div class="image-container">
        <img src="https://in.musafir.com/uploads/5_4_d115f28046.webp" alt="Nature">
      </div>
      <div class="container">
        <h2>Overview</h2>
...
Kashmiri Cuisine: Savor the famous Wazwan cuisine, including dishes like Rogan Josh, Gustaba, Yakhni, and the iconic Kahwa tea.</li>
    ...
    <section id="includes">
      <div class="container">
        ...
        <ul>
          ...
          <li>Transport: Moscow to Saint Petersburg (Sapsan train): ~₹500–₹1000 (economy), Metro and local transport: ~₹50 per day.</li>
    ...
    <section id="booking">
      <div class="container">
        ...
        <a href="booking.php?place_name=Kashmir&price=40000&guide_name=Samira%20Rane&contact_no=8880111111" class="btn">Book Now</a>
