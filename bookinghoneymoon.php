...
<input type="number" id="quantity" name="quantity" value="1" min="1" max="2" required onchange="validateQuantity();updateAdditionalForms()">
...
function validateQuantity() {
    ...
    if (quantity > 2) {
        alert("No more than 2 people are allowed!");
        quantityInput.value = 2; // Reset to max allowed value
    } else if (quantity < 1) {
        alert("Minimum 1 person is required!");
        quantityInput.value = 1; // Reset to min allowed value
    }
}
</script>
