      ...
      <div class="packages-container">
        ...
        <div class="package-card">
          ...
          <div class="content">
            ...
            <div class="details">
              <div><i class="fas fa-clock"></i> 10 Days</div>
        ...
        <div class="package-card">
          ...
          <div class="content">
            ...
            <div class="details">
              <div><i class="fas fa-clock"></i> 7 Days</div>
              <div><i class="fas fa-map-marker-alt"></i> India</div>
            </div>
          </div>
        </div>
      ...
      <div class="packages-container">
        ...
        <div class="package-card">
          ...
          <div class="content">
            ...
            <p>Rs. 90,000/- Per Person</p>
            <div class="details">
              <div><i class="fas fa-clock"></i> 4 Days</div>
      ...
      <div class="packages-container">
        ...
        <div class="package-card">
          ...
          <div class="content">
            ...
            <p>Rs. 78,000/- Per Person</p>
            <div class="details">
              <div><i class="fas fa-clock"></i> 6 Days</div>
