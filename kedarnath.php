  ...
  <body>
    ...
    <section id="overview">
      <div class="image-container">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Kedarnath_Temple_in_Rainy_season.jpg/1200px-Kedarnath_Temple_in_Rainy_season.jpg" alt="Kedarnath">
      </div>
      <div class="container">
        <h2>Overview</h2>
    ...
    <section id="includes">
      <div class="container">
        ...
        <ul>
          <li>Accommodation: $50–$150 per night (budget to mid-range).</li>
          <li>Meals: $10–$30 per day per person (local vegetarian food).</li>
          <li>Transport: Bus or private taxi costing approximately $20–$100 per day.</li>
          <li>Attractions: Temple entry and trekking permits as applicable.</li>
        </ul>
      </div>
    </section>
