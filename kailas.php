<?php
?>
<a href="booking.php?place_name=Kailash%20Manasarovar&price=250000"></a>
  ...
  <body>
    ...
    <section id="overview">
      <div class="image-container">
        <img src="https://www.holidaystonepal.in/media/files/Blogs/Kailash-Parvat-Photos/Mount-Kailash.png" alt="Kailash Manasarovar">
      </div>
      <div class="container">
        <h2>Overview</h2>
    ...
    <section id="includes">
      <div class="container">
        ...
        <ul>
          <li>Accommodation: $70–$200 per night (depending on location).</li>
          <li>Meals: $20–$50 per day per person.</li>
          <li>Transport: Buses, jeeps, and support vehicles costing approximately $100–$300 per day.</li>
          <li>Permits and Attractions: Costs for permits and guides: $500–$700.</li>
        </ul>
      </div>
    </section>
    ...
    <section id="booking">
      <div class="container">
        ...
        <a href="booking.php?place_name=Kailash%20Manasarovar&price=250000&guide_name=Mayur%20patil&contact_no=9034118732" class="btn">Book Now</a>
      </div>
    </section>
